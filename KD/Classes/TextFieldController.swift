...
class TextFieldController: UITextField {
    ...
    private func setUpTextField(placeholder: String) {
        ...
        //        layer.backgroundColor = UIConstants.Colors.colorForBackGroundTextField
...
//        layer.shadowRadius = 10 // скругление тени
//        layer.shadowOpacity = 0.4 //насыщенность тени
//        layer.shadowOffset = CGSize(width: 15, height: 15) //смещение тени
